...
const NewsSection = () => {
  return (
    <div className='flex flex-col gap-8 mx-4 md:mx-40 my-24 p-8 bg-white rounded-3xl drop-shadow-2xl'>
      ...
      <div className='flex flex-col sm:flex-row gap-12'>
        ...
        <div className='flex flex-row gap-4 md:w-1/2'>
          ...
          <div className='flex flex-row gap-12 md:w-1/2'>
            <div className='flex flex-col gap-4 shrink w-1/2'>
