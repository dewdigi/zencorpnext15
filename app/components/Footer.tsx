        ...
        <div className='flex flex-col lg:mx-20 lg:flex-row bg-Primary-1/100 '>
            ...
            <div className=' lg:w-3/12  items-center rounded-md lg:items-start m-2 lg:px-4 lg:py-8 flex flex-col text-left  text-white'>
                    ...
                    <p className='m-2 text-xs text-center lg:text-left'><span className='font-bold'>Address: </span> </p>
                        <p className='lg:mx-2 text-xs text-center lg:text-left flex-wrap'>ZENCORP TRADING CO. LLC, AL KHABEESI BLDG - Office No3, Dubai, UAE, <span className='font-bold'>TRN:</span> 100315782100003 </p>
            ...
            <button type="button" className="px-5 py-2.5 text-sm  font-medium text-white inline-flex items-center bg-Secondary-2/70 hover:bg-lime-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-Secondary-2/70 dark:hover:bg-Primary-1/70 dark:focus:ring-blue-800" onClick={() => window.location.href = 'mailto:info@zencorp.ae?subject=Inquiry&body=Hello, I would like to know more about...'}>
