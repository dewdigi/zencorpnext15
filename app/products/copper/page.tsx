    ...
    <div>
      ...
      >
        ...
        <div className='backdrop-blur-sm bg-gradient-to-b from-Secondary-2/60/[.2] via-Secondary-2/80/[.6] to-black rounded-bl-[100px]'>
          ...
          <div className="flex flex-col lg:justify-start justify-center items-center lg:items-start py-32 my-0 lg:mx-24 lg:my-0 lg:py-60 p-6 lg:pb-28 text-white gap-22">
      ...
      <div className='md:m-10 m-8 flex flex-col sm:flex-row md:gap-4 bg-Primary-1/10 rounded-[20px]'>
        <div className='md:p-20 p-4 m-2 gap-8 flex flex-col justify-center'>
          <div className='flex gap-4 flex-col'>
            <h2 className='text-5xl font-bold lg:text-left dark:text-gray-700 text-center'>Our Expertise</h2>
            <h4 className='text-xl lg:text-left  dark:text-gray-700 text-center'>From Mine to Market: Comprehensive Copper Solutions</h4>
          </div>
      ...
      <div className='md:m-20 m-8 flex flex-col sm:flex-row md:gap-4 rounded-xl bg-white rounded-2xl '>   
        ...
        <div className='md:p-20 p-4 m-2 gap-4 md:w-1/2 flex flex-col  dark:text-gray-700 justify-center'>
