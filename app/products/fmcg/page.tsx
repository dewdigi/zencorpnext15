  ...
  return (
    <div>
        ...
        <div className='backdrop-blur-sm bg-gradient-to-b from-Secondary-2/60/[.2] via-Secondary-2/80/[.6] to-black rounded-bl-[100px]'>
          ...
          <div className="flex flex-col lg:justify-start justify-center items-center lg:items-start my-32 lg:m-24 lg:my-32 p-6 lg:pb-28 text-white gap-22">
            <h1 className="text-5xl md:text-6xl leading-36 my-4 text-center sm:text-left">
              <b>FMCG </b> <span className='text-3xl'> &#40;Fast-Moving Consumer Goods&#41;</span> <br />
      ...
      <div className='flex lg:flex-row flex-col lg:gap-20 lg:m-20 items-center  justify-center'>
          ...
          <h2 className='font-bold text-3xl md:text-5xl dark:text-white text-accent-3/100'>The <span className='text-Primary-1/70 underline'>Copper</span> Advantage</h2>
      ...
      <div className='md:m-10 m-8 flex flex-col sm:flex-row md:gap-4 bg-Primary-1/10 rounded-[20px]'>
        <div className='md:p-20 p-4 m-2 gap-8 flex flex-col justify-center'>
          <div className='flex gap-4 flex-col'>
            <h2 className='text-5xl font-bold lg:text-left text-center dark:text-gray-800'>Our Expertise</h2>
            <h4 className='text-xl lg:text-left text-center dark:text-gray-800'>From Mine to Market: Comprehensive Copper Solutions</h4>
          </div>

          <div className='flex lg:flex-row flex-col gap-8 '>
            <div className='flex flex-col lg:w-1/2 bg-gray-100 p-8 rounded-2xl '>
              <div className='lg:p-8'> 
                <p className='text-xl md:text-left text-center font-bold dark:text-gray-800'>Upstream Copper Raw Materials</p>
                <p className='text-lg py-2 dark:text-gray-800'>We source and trade:</p>
                <div className='p-4 bg-white rounded-2xl'>
                 <ul className='list-disc p-2 mx-2 dark:text-gray-800 ' >             
            ...
            <div className='flex flex-col lg:w-1/2 bg-gray-100 dark:text-gray-800 p-8 rounded-2xl '>
              <div className='lg:p-8'> 
